...
import workPreview32 from '../img/projectPreviews/pingpong/1.jpg';
import workPreview33 from '../img/projectPreviews/pingpong/2.jpg';
import workPreview34 from '../img/projectPreviews/pingpong/3.jpg';
import workPreview35 from '../img/projectPreviews/pingpong/4.jpeg';
import workPreview36 from '../img/projectPreviews/pingpong/5.jpeg';
import workPreview37 from '../img/projectPreviews/pingpong/6.jpeg';
import workPreview38 from '../img/projectPreviews/pingpong/7.jpeg';
import workPreview39 from '../img/projectPreviews/pingpong/8.jpeg';
import workPreview40 from '../img/projectPreviews/pingpong/9.jpeg';
...
const data = {
	...
	projects: [
		...
		},
		{
			...
			medium: 'HTML, SCSS',
			previewDescription: `This responsive single page designed website uses flexbox, micro-animations, and a CSS only hamburger button.`,
			description: `This responsive single page designed website uses flexbox, micro-animations, and a CSS only hamburger button.`,
			workPreview0: workPreview0,
			trapWorkDescription0:`In order to give the site a bit more than just a still site, I added micro-animations to the buttons when you hover over them.`,
		...
		},
		{
			...
			previewDescription: `This helper app for Pokemon Go! uses the Google Maps API and a public Pokedex API to plot likely real world locations for finding in-game pokemon. It uses Axios for AJAX and Bootstrap for styling.`,
			description: `This helper app for Pokemon Go! uses the Google Maps API and a public Pokedex API to plot likely real world locations for finding in-game pokemon. It uses Axios for AJAX and Bootstrap for styling.`,
			...
			pokeWorkDescription1:`The Pokemon you searched for will drop on the map in correlation to where they would most likely be found in real life by combining Pokemon type and places on the Google Places API.`,
		...
		},
		{
			...
			medium: 'HTML, SCSS, JS',
			previewDescription: `This responsive multi-page designed website, uses modern complex design elements and a javascript driven hamburger button.`,
			description: `This responsive multi-page designed website, uses complex design elements and a javascript driven hamburger button.`,
			workPreview0: workPreview29,
			uniWorkDescription0:`This site was more challenging than I had originally thought, with each page having its own custom marker element in the top left.`,
			workPreview1: workPreview30,
			workPreview2: workPreview31,
			uniWorkDescription1:`The large overlapping tiles were also a challenging CSS puzzle. `,
		...
		},
		{
			...
			medium: 'HTML, JS, SCSS',
			previewDescription: `This responsive e-commerce website has complex angled buttons built with CSS pseudo-classes, custom animated drop-down select elements, and full ARIA accessibility.`,
			description: `This responsive e-commerce website has complex angled buttons built with CSS pseudo-classes, custom animated drop-down select elements, and full ARIA accessibility.`,
			workPreview0: workPreview18,
			sucWorkDescription0:`Interesting and unique elements made this site a challenge to develop.`,
		...
		},
		{
			...
			previewDescription: `This web app was created with the purpose of being a huge collaborative mind map that starts with one word and spreads throughout the 100,000,000px plane and gets more and more chaotic as it goes.`,
			description: `This web app was created with the purpose of being a huge collaborative mind map that starts with one word and spreads throughout the 100,000,000px plane and gets more and more chaotic as it goes. 
			The app connects to a custom PHP back end, and the mind map is shared, live, by all users. 
			...
			mindWorkDescription1:`Now type your word, put your name, choose your font size, rotation angle, color, and watch it change in real time with the use of GSAP animations.`,
			workPreview2: workPreview9,
			mindWorkDescription2:`Listen to the Mind Brain. It knows all.`,
			workPreview3: workPreview10,
			mindWorkDescription3:`Because the entirety of the site is 100,000,000px, i've added a few lines of JS to output the location of your crosshair into the URL. This way you can send it to anyone, and they can add onto your word without having to search for hours.`,
...

		{
			...
			previewDescription: `This simple yet ridiculous web messaging app is a game where you're trying to figure out what the other person said using only gifs and synonyms.`,
			description: `This simple yet ridiculous web messaging app is a game where you're trying to figure out what the other person said using only gifs and synonyms. 
			It was made using Node.js to create a local server and Socket.io to link two or more people to talk using GIFs. It then was brought in with the giphy API and combined with a dictionary API to pull synonyms of the words from your message. Open the site on more than one device in order to get the full effect and play with the app and see who can stump who the most.`,
		...
		},
		{
			...
			energyWorkDescription0:`In order to give the feel of the lights coming on, all of the SVGs on this site are drawn in on scroll using a combination of Greensock, Waypoints, and SVG Artista.`,
		...
		},
		{
			...
			previewDescription: `This physical real life clock was made with 180 LED lights, 180 Ping Pong Balls, an RTC, and an Arduino Uno to run the code that makes it work. It required extensive planning and problem solving throughout its creation. `,
			description: `This physical real life clock was made with 180 LED lights and Ping Pong Balls, an RTC, and an Arduino Uno to run the code that makes it work. It required extensive planning and problem solving throughout its creation. `,
			workPreview0:workPreview32,
			workPreview1:workPreview33,
			workPreview2:workPreview34,
			pingWorkDescription0:`Creating the frame.`,
			workPreview3:workPreview35,
			workPreview4:workPreview36,
			pingWorkDescription1:`Fixing the lights and balls to the matboard.`,
			workPreview5:workPreview37,
			workPreview6:workPreview38,
			workPreview7:workPreview39,
			pingWorkDescription2:`Now do it 180 more times and wire it up.`,
			workPreview8:workPreview40,
		...
		},
		{
			...
			vidNote:`Unmute this.`,
			video: `
			<iframe width="420" height="345" src='https://www.youtube.com/embed/sHjcJsvjgaw?autoplay=1&mute=1'></iframe>`,
		},
	],
